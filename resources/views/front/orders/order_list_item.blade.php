                ...
                <div class="card mb-6">
                    <div class="card-body">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-6 col-lg-4	col-xl-4 offset-lg-2">
							...
							<small  class="text-primary">Status : {{ $item['order_status']}} </small> <span class="float-end d-flex justify-content-center align-items-center big-dot dot">
