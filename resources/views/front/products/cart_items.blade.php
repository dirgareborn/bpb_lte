            ...
            <div class="col-11">
				...
				<form class="" action="javascript:;">
                    <div class="input-group">
                        ...
                        <button @if(Auth::check()) user="1" @endif type="submit" id="ApplyCoupon" class="btn btn-primary">Pakai</button>
                    </div>
                </form>
				<br>
					<small><span class="text-muted">Jika ada kendala transaksi, Silahan Klik <a href="https://api.whatsapp.com/send?phone=6285343704359" class="btn btn-xs  btn-link"><strong>Link ini</strong></a> Untuk terhubung dengan admin</span></small>
				</div>
				<div class="col-md-6">
				<div class="card rounded-0">
                    <div class="card-body p-4 d-flex flex-row">
                        <div data-mdb-input-init class="form-outline flex-fill">
                            <h6 class="form-label ">Total @currency($total_price)</h6> 
